      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-6">
            <span className="text-white/55 font-bold tracking-[0.3em] text-[10px] uppercase block">
              {t("about.label")}
            </span>
            <h2 className="text-4xl md:text-6xl font-light text-white tracking-tight leading-tight">
              {t("about.title")}
            </h2>
            <div className="w-16 h-1 bg-brand-orange shadow-[0_0_16px_1px_rgba(232,93,38,0.5)]"></div>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative h-[480px] rounded-none overflow-hidden shadow-2xl border border-white/10 bg-charcoal-950">
              <div className="absolute top-0 left-0 right-0 h-1 bg-brand-orange z-10 shadow-[0_0_16px_1px_rgba(232,93,38,0.6)]"></div>
              <img
                src={commitImg}
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-charcoal-900/90 backdrop-blur-md border border-brand-orange/30 shadow-[0_0_25px_-5px_rgba(232,93,38,0.4)] p-5 rounded-none">
                <p className="text-brand-orange font-mono text-[9px] uppercase tracking-[0.3em] mb-1.5 font-bold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-20 pt-20 border-t border-white/5">
          <div className="bg-charcoal-900/50 border border-white/10 border-t-2 border-t-brand-orange p-8 space-y-4 hover:border-brand-orange/60 transition-colors duration-300">
            <div className="flex items-center gap-3">
              <Eye className="h-5 w-5 text-brand-orange" />
              <h3 className="text-2xl font-bold text-white uppercase tracking-wider">{t("about.vision.title")}</h3>
            </div>
            <div className="w-10 h-[3px] bg-brand-orange"></div>
            <p className="text-white/80 text-base leading-relaxed font-light">{t("about.vision.text")}</p>
          </div>
          <div className="bg-charcoal-900/50 border border-white/10 border-t-2 border-t-brand-orange p-8 space-y-4 hover:border-brand-orange/60 transition-colors duration-300">
            <div className="flex items-center gap-3">
              <Target className="h-5 w-5 text-brand-orange" />
              <h3 className="text-2xl font-bold text-white uppercase tracking-wider">{t("about.mission.title")}</h3>
            </div>
            <div className="w-10 h-[3px] bg-brand-orange"></div>
            <p className="text-white/80 text-base leading-relaxed font-light">{t("about.mission.text")}</p>
          </div>
        </div>
        ...
        <div className="mt-16">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-2xl font-bold text-white uppercase tracking-wider">{t("about.values.title")}</h3>
          </div>
          <div className="w-10 h-[3px] bg-brand-orange mb-8"></div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {valueKeys.map((key, idx) => (
              <div key={idx} className="flex gap-4 border-l-2 border-brand-orange/50 pl-5 py-1 hover:border-brand-orange transition-colors duration-300">
                <span className="text-brand-orange/70 font-mono text-xs pt-0.5">0{idx + 1}</span>
                <p className="text-white/80 text-base leading-relaxed font-light">{t(key)}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mt-16">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-2xl font-bold text-white uppercase tracking-wider">{t("about.services.title")}</h3>
          </div>
          <div className="w-10 h-[3px] bg-brand-orange mb-8"></div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {serviceKeys.map((key, idx) => (
              <div
                key={idx}
                className="border border-white/10 bg-charcoal-900/30 p-5 border-b-2 border-b-transparent hover:border-brand-orange hover:bg-charcoal-900/60 transition-all duration-300"
              >
                <span className="text-brand-orange/70 font-mono text-[10px] block mb-2">0{idx + 1}</span>
